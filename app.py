...
def load_setting():
    settings = {
        ...
        'Surgery': {'values': ["None", 'Amputation', "Local destruction or excision", "Radical excision with limb salvage"],
                    'type': 'selectbox', 'init_value': 1, 'add_after': ''},
        'Systemic therapy': {'values': ["No", "Before surgery",'After surgery','Both before and after surgery'], 'type': 'selectbox', 'init_value': 0, 'add_after': '(Chemotherapy)'},
        ...
        'Tumor extension': {'values': ["No break in periosteum", "Extension beyond periosteum", "Further extension"],
                            'type': 'selectbox', 'init_value': 1, 'add_after': ''},
        'Distant metastasis': {'values': ["No", "Lung only",'Other distant organ'], 'type': 'selectbox',
                               'init_value': 0,
                               'add_after': ''}
    }
    input_keys = ['Age', 'Distant metastasis', 'Gender', 'Grade', 'Marital status','Number of tumors',
        'Surgery','Systemic therapy', 'Tumor extension', 'Tumor size']
